...
class PersianDatePickerController {
    ...
    private var _yearRange: MutableState<Int> = mutableStateOf(10)
    internal val yearRange get() = _yearRange.value

    private var _minYear: MutableState<Int> = mutableStateOf(getPersianYear() - yearRange)
    internal val minYear get() = _minYear.value

    private var _maxYear: MutableState<Int> = mutableStateOf(getPersianYear() + yearRange)
    internal val maxYear get() = _maxYear.value

    private var _maxMonth: MutableState<Int> = mutableStateOf(12)
    internal val maxMonth get() = _maxMonth.value

    private var _maxDay: MutableState<Int> = mutableStateOf(31)
    internal val maxDay get() = _maxDay.value

    private var _selectedYear: MutableState<Int> = mutableStateOf(getPersianYear())
    internal val selectedYear get() = _selectedYear.value

    private var _selectedMonth: MutableState<Int> = mutableStateOf(getPersianMonth())
    internal val selectedMonth get() = _selectedMonth.value

    private var _selectedDay: MutableState<Int> = mutableStateOf(getPersianDay())
